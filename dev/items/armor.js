...
ArmorTick.attachTo({
	...
	type: 0,
	tick: function() {
		Entity.addEffect(Player.get(), 16, 1, 20, false, false);
		Entity.addEffect(Player.get(), 23, 190, 20, false, false);
		Entity.addEffect(Player.get(), 13, 190, 20, false, false);
	}
});
...
ArmorTick.attachTo({
	...
	type: 1,
	tick: function() {
		Entity.addEffect(Player.get(), 11, 190, 20, false, false);
		Entity.addEffect(Player.get(), 10, 190, 20, false, false);
...
ArmorTick.attachTo({
	...
	type: 2,
	tick: function() {
		Entity.addEffect(Player.get(), 1, 9, 20, false, false);
	}
});
...
ArmorTick.attachTo({
	...
	type: 3,
	tick: function() {
		Entity.addEffect(Player.get(), 8, 3, 20, false, false);
	}
});
