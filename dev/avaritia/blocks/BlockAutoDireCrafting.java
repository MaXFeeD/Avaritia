...
public class BlockAutoDireCrafting extends BlockContainer
{
    ...
    public BlockAutoDireCrafting() {
        ...
        this.func_149663_c("auto_dire_crafting");
    ...
    public void func_149651_a(final IIconRegister iconRegister) {
        BlockAutoDireCrafting.top = iconRegister.func_94245_a("avaritia:dire_autocrafting_top");
        BlockAutoDireCrafting.sides = iconRegister.func_94245_a("avaritia:dire_autocrafting_side");
        BlockAutoDireCrafting.bottom = iconRegister.func_94245_a("avaritia:block_crystal_matrix");
    }
    
    @SideOnly(Side.CLIENT)
    public IIcon func_149691_a(final int side, final int metadata) {
        if (side == 0) {
            return BlockAutoDireCrafting.bottom;
        }
        if (side == 1) {
            return BlockAutoDireCrafting.top;
        }
        return BlockAutoDireCrafting.sides;
    }
    ...
    public boolean func_149727_a(final World world, final int x, final int y, final int z, final EntityPlayer player, final int par6, final float par7, final float par8, final float par9) {
        ...
        player.openGui((Object)Avaritia.instance, 4, world, x, y, z);
        return true;
    }
    ...
    public void func_149749_a(final World world, final int x, final int y, final int z, final Block block, final int wut) {
        final TileEntityAutoDireCrafting craft = (TileEntityAutoDireCrafting)world.func_147438_o(x, y, z);
        if (craft != null) {
            for (int i = 1; i < 82; ++i) {
