...
public class BlockCompressor extends BlockContainer
{
    ...
    public BlockCompressor() {
        ...
        this.func_149663_c("neutronium_compressor");
    ...
    public void func_149651_a(final IIconRegister iconRegister) {
        this.top = iconRegister.func_94245_a("avaritia:compressor_top");
        this.sides = iconRegister.func_94245_a("avaritia:compressor_side");
        this.front = iconRegister.func_94245_a("avaritia:compressor_front");
    }
    ...
    public IIcon func_149673_e(final IBlockAccess world, final int x, final int y, final int z, final int side) {
        ...
        int facing = 2;
        final TileEntityCompressor machine = (TileEntityCompressor)world.func_147438_o(x, y, z);
        if (machine != null) {
    ...
    public boolean func_149727_a(final World world, final int x, final int y, final int z, final EntityPlayer player, final int par6, final float par7, final float par8, final float par9) {
        ...
        player.openGui((Object)Avaritia.instance, 3, world, x, y, z);
        return true;
    }
    ...
    public void func_149689_a(final World world, final int x, final int y, final int z, final EntityLivingBase player, final ItemStack item) {
        ...
        if (tile instanceof TileEntityCompressor) {
            final TileEntityCompressor machine = (TileEntityCompressor)tile;
    ...
    public void func_149749_a(final World world, final int x, final int y, final int z, final Block block, final int wut) {
        final TileEntityCompressor compressor = (TileEntityCompressor)world.func_147438_o(x, y, z);
        if (compressor != null) {
            for (int i = 0; i < 2; ++i) {
                final ItemStack itemstack = compressor.func_70301_a(i);
                if (itemstack != null) {
