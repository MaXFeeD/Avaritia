...
public class ContainerExtremeCrafting extends Container
{
    ...
    public ContainerExtremeCrafting(final InventoryPlayer player, final World world, final int x, final int y, final int z, final TileEntityDireCrafting table) {
        this.worldObj = world;
        this.posX = x;
        this.posY = y;
        this.posZ = z;
        this.craftMatrix = new InventoryDireCrafting(this, table);
        this.craftResult = (IInventory)new InventoryDireCraftResult(table);
