...
Translation.addTranslation("Infinity catalyst", { ru: "Катализатор бесконечности" });
...
Translation.addTranslation("Extrime workbench", { ru: "Экстремально сжатый верстак" });
...
Translation.addTranslation("Cosmos meatballs", { ru: "Космические фрикадельки'" });
